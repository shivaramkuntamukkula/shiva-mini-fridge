...
#define CHARACTERISTIC_UUID_02 "beb5483e-36e1-4688-b7f5-ea07361b26a9"
...
for(int i = 0; i < 4; i++){
    ...
    if (message == 49){
      ...
      int i;
       for( i=1;i<1000;i++){
        long int tmpval= (5351623-reading_J7)/i;
          if(abs(tmpval-100)<=1){
...
Serial.print("Offset Val of  J7 :");Serial.println(reading_J7);
