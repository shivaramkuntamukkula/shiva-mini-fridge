...
```
cd existing_repo
git remote add origin https://gitlab.com/n.navaratnarajah/mini-bar-test-code.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/n.navaratnarajah/mini-bar-test-code/-/settings/integrations)
